...
class _ActiveRidesState extends State<ActiveRides> {
  ...
  Future loadActiveRides() async {
    try {
      final data = await bookingService.getActiveRides();
      if (mounted) {
        setState(() {
          activeRides = data;
          isLoading = false;
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final booking = activeRides[index];
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            "Once a captain approves your booking, it will appear here.",
